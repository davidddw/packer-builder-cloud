...
func (self *stepCreateInstance) Run(state multistep.StateBag) multistep.StepAction {
	...
	err = instance.SetStaticMemoryRange(uint64(config.VMMemory*1024*1024), 
	    uint64(config.VMMemory*1024*1024))
	if err != nil {
	...
	err = instance.ConnectVdi(vdi, xsclient.Disk, "autodetect")
	if err != nil {
